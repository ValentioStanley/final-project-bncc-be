    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @else
                    <a href="{{route('loginUser')}}" class="btn btn-outline-success">Login</a>
                @endauth
            </div>
        </div>
    </nav>
    <h3>Welcome to our item, Admin. Please don't forget to do your work!</h3>
    <div class="d-flex m-5" style="align-items: center; gap: 30px; text-align: center;">
        @foreach ($items as $item)
        <div class="card" style="width: 18rem;">
            <div class="card p-4">
                <img src="{{ asset('/storage/images/'.$item->fotoBarang) }}" width= '50' height='70' class="card-img-top" alt="Barang">
                ...
                <div class="mt-2">
                    <a href="{{route('editItem', ['id'=>$item->id])}}" class="btn btn-success">Update Item</a>
